  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-purple-100">
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="bg-white shadow-xl rounded-lg p-8 mt-4 mb-24">
          <div className="flex justify-between items-center mb-10">
            ...
            <Button size="sm" className="bg-indigo-500 hover:bg-indigo-600">Get Tracking Script</Button>
          </div>
          ...
          <div className="mb-6">
            <div className="flex items-center mb-2">
              ...
              <div className="ml-auto">
                <Button variant="ghost" size="sm">Generate new insight</Button>
              </div>
            </div>
